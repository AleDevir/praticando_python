...
opcoes_de_transporte:  dict[str, str ] = {
    'A': 'Avião',
    'O': 'Ônibus',
    'C': 'Carro',    
}

opcoes_do_menu_transporte:list = list(opcoes_de_transporte)
...
def main() -> None:
    ...
    while True:
        ...
        transporte = input_opcoes('\tTipo de transporte: ', opcoes_do_menu_transporte)
